...
<g:set var="entityName" value="${message(code: 'calendario.evento', default: 'Calendario')}" />
...
<div class="col-sm-10 col-lg-10">
    <ul class="breadcrumb">
        ...
        <li><g:link action="calendario"><g:message code="calendario.label" args="[entityName]" /></g:link></li>
        ...
        <div class="box col-md-12">
            <g:link controller="calendario" action="calendario">
                <button class="btn btn-default">
                    ...
                    <g:message code="calendario.label" args="[entityName]" />
                </button>
            </g:link>
        </div>
    </div>
